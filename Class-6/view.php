<?php
    ...
    // }
    ...
    else if(empty($gander)){
        $err_msg = "pola na maiya heida ko ?";
        header('location:index.php?gander_err='.$err_msg);
    }
    else if(empty($hobbies)){
        $err_msg = "kono khelay pasor na ?";
        header('location:index.php?hobbies_err='.$err_msg);
    }
    else if(empty($subject)){
        $err_msg = "bisoy gulo posondo kor ?";
        header('location:index.php?sub_err='.$err_msg);
    }
        ...
        echo "Gander : ".$gander;
        echo "<br>";
        echo "Hobbies : ".$after_implode_hobbies;
        echo "<br>";
        echo "Subject : ".$after_implode_subject;
    }
